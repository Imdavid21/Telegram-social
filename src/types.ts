...
export interface TelegramAccount {
  id:string; firstName:string; lastName?:string; username?:string; usernames?:string[]; bio?:string; premium?:boolean; verified?:boolean; scam?:boolean; fake?:boolean; avatar?:string; commonChatsCount?:number; voiceMessagesForbidden?:boolean; translationDisabled?:boolean
  settings?: { sensitiveContentEnabled?:boolean; canSetContentSettings?:boolean; archiveAndMuteNewNoncontactPeers?:boolean; keepArchivedUnmuted?:boolean; keepArchivedFolders?:boolean; hideReadMarks?:boolean }
...
export interface FeedDiagnostics { [key:string]:unknown }
...
export interface FeedUpdate { seq:number; item?:FeedItem; type?:string; [key:string]:unknown }
export interface TelegramSearchResponse { query:string; channels:Channel[]; results:FeedItem[]; total:number; hasMore:boolean; scope:string; sourceId?:string }
